...
Visualization parameters, including the ability for the user to
...
aimed at its execution on FPGAs. 

The tool expects a set of C source files containing
...
the data, execute the remote code and retrieve back the result data). 

Special comments in the C code help PoRoTo decide on which are the original data structures
...
The embedded many-core platform offers flexibility and scalability to cater
...
The programming model targets heterogeneous
