...
* annotations.
*/
public class STMLAnnotation extends PragmaAnnotation {
    ...
    */
    public STMLAnnotation(String key, Object value) {
        super();
        put(key, value);
    }
    ...
    */
    ...
    public String toString() {
        ...
        str.append(super.toString()).append("stml").append(" ");
        ...
        for (String key : keySet()) {
            ...
            //     str.append(") ");
            // } else {
                str.append(key).append(" ").append(get(key).toString()).append(" ");
            // }
        }
        return str.toString();
    }
