...
public class DDGraph {
    ...
    static public class Arc {
        ...
        public boolean isCarried(Loop l) {
            ...
            // int direction = ;
            // System.out.println("\t"+ dv.VectorToString() + " " + ((dv.getDirectionVector()).containsKey(l) ? dv.getDirection(l):-1) + " " + is_carried_for_loop);
        ...
        public boolean containsLoopCarriedDependence() {
            ...
            // System.out.println("\t"+ dv.VectorToString() + " " + loop_carried);
            return loop_carried;
        }
        ...
        public String getDependenceTypeStr()
        {
             /* byte depType
             * 1 - Flow (True) Dependence
             * 2 - Anti Dependence
             ...
             * 4 - Input Dependence
             */
            switch (Byte.valueOf(this.depType)) {
                case 1:  
                    return "flow";
                case 2:
                    return "anti";
